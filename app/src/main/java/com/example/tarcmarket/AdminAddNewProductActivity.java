...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    private void ValidateProductDate()
    {
        ...
        if (ImageUri == null)
        {
            Toast.makeText(this, "Product image is not selected", Toast.LENGTH_SHORT).show();
        }

        else if (TextUtils.isEmpty(Description))
        {
            Toast.makeText(this, " Please enter the description for the product ", Toast.LENGTH_SHORT).show();
        }

        else if (TextUtils.isEmpty(Price))
        {
            Toast.makeText(this, " Please enter the price for the product ", Toast.LENGTH_SHORT).show();
        }

        else if (TextUtils.isEmpty(ProductName))
        {
            Toast.makeText(this, " Please enter the name of product ", Toast.LENGTH_SHORT).show();
        }
    ...
    private void StoreProductInformation()
    {
        ...
        loadingBar.setMessage("Please wait, new product is currently adding.");
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        else
                        {
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this, " Error occurs: " + message, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
