    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(ProductDetailsActivity.this, "Purchase will be available after the shipment", Toast.LENGTH_LONG).show();
                }
                else
                {
                    addingToCartList();
                            ...
                            cartListRef.child("Admin View").child(Prevalent.currentOnlineUser.getPhone()).child("Products")
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            if (task.isSuccessful())
                                            {
                                                Toast.makeText(ProductDetailsActivity.this, "Product is added to cart list.", Toast.LENGTH_SHORT).show();
